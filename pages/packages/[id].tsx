      ...
      <section className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-8">
          <Card className="shadow-lg   md:col-span-8">
            <nav className="w-full  grid grid-cols-2 md:grid-cols-3 text-[13px] lg:text-[16px] xl:text-[18px] justify-between ">
              <button
